...
export default function Page() {
  ...
  const [ts] = useState(() => Date.now()); // anti-bot: time on page
  ...
  useEffect(() => {
    ...
    if (!key) return; // still works without, backend will reject
  ...
  const hero = useMemo(
    () => ({
      src: '/hero-bg-venice.mp4', // put this in /public
      poster: '/hero-poster.jpg', // optional /public
    }),
    []
  );
  ...
  /* form submit with honeypot + reCAPTCHA */
  const handleQuote = async e => {
    ...
    // Track form open timestamp (anti-spam dwell time)
    data.ts = ts;
  ...
  return (
    <>
      ...
      <div>
        ...
        {/* Selected Work — local looping videos */}
        <section
          id="work"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              <div className="lg:col-span-2">
                ...
                <p className="mt-4 text-neutral-600 dark:text-neutral-300 max-w-2xl">
                  ...
                  aerials for ads, property showcases, tourism boards, and
                  events. I operate sub-250g (C0) with liability insurance and
        ...
        <footer className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-neutral-600 dark:text-neutral-400">
              (c) {new Date().getFullYear()} NordSky Aerials. All rights
              reserved.
            </div>
